...
class FeatureSettings extends Page
{
    ...
    {
        $disabled = collect(['login_register', 'toko'])
            ...
            Section::make('Autentikasi Pengguna')
                ...
                ->schema([
                    Toggle::make('feature_login_register')
                        ...
                        ->default(true)
                        ->live()
                        ->helperText('Nonaktifkan agar pengunjung tidak bisa masuk atau mendaftar akun. Checkout toko tidak tersedia tanpa login.'),
                ]),
